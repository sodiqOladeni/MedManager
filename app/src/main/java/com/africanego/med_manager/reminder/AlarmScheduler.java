...
/**
 * Created by ${sodiqOladeni} on 3/26/2018.
 */

public class AlarmScheduler {

    /**
     * Schedule a AlarmScheduler alarm at the specified time for the given task.
     *
    ...
    public void setAlarm(Context context, long alarmTime, long reminderTask) {
    ...
    public void setRepeatAlarm(Context context, long alarmTime, long reminderTask, long RepeatTime) {
        AlarmManager manager = AlarmManagerProvider.getAlarmManager(context);
    ...
    public void cancelAlarm(Context context, long reminderTask) {
        AlarmManager manager = AlarmManagerProvider.getAlarmManager(context);
